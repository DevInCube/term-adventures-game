...
System.register("utils/typing", [], function (exports_14, context_14) {
    ...
    return {
        setters: [],
        execute: function () {
            exports_14("isNotNullable", isNotNullable = (x) => x !== null);
        }
    };
});
...
System.register("engine/objects/Tile", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "world/sprites/waterRippleSprite", "engine/objects/Particle", "engine/math/Vector2", "engine/components/CompositeObjectSkin", "engine/effects/Effect", "utils/hash", "utils/random", "utils/Lazy"], function (exports_29, context_29) {
    "use strict";
    var Object2D_3, ObjectSkin_4, ObjectPhysics_3, waterRippleSprite_1, Particle_1, Vector2_10, CompositeObjectSkin_1, Effect_1, hash_1, random_1, Lazy_1, _position, Tile;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_29("Tile", Tile);
            Tile.maxSnowLevel = 4;
            Tile.maxMudLevel = 4;
        }
    };
});
System.register("engine/objects/NpcMovementOptions", [], function (exports_30, context_30) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_30("NpcMovementOptions", NpcMovementOptions);
            exports_30("defaultMovementOptions", defaultMovementOptions = {
                walking: {
                    walkingSpeed: 4,
                    swimmingSpeed: 1,
                },
...
System.register("engine/signaling/SignalType", [], function (exports_31, context_31) {
    "use strict";
    ...
    return {
        setters: [],
        execute: function () {
            exports_31("SignalTypes", SignalTypes = ["light", "life", "fire", "weather", "mind", "darkness"]);
            exports_31("SignalColors", SignalColors = ["white", "green", "red", "cyan", "yellow", "blue"]);
        }
    };
});
System.register("engine/signaling/Signal", [], function (exports_32, context_32) {
    "use strict";
...
System.register("engine/signaling/SignalTransfer", [], function (exports_33, context_33) {
    "use strict";
...
System.register("engine/signaling/ISignalProcessor", [], function (exports_34, context_34) {
    "use strict";
    ...
    exports_34("isAnISignalProcessor", isAnISignalProcessor);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("engine/signaling/SignalProcessor", ["engine/signaling/ISignalProcessor", "engine/math/Grid", "engine/math/Vector2", "engine/math/Rotation"], function (exports_35, context_35) {
    "use strict";
...
System.register("engine/ActionData", ["engine/math/Vector2"], function (exports_36, context_36) {
    "use strict";
    ...
    exports_36("convertToActionData", convertToActionData);
    ...
    exports_36("getNpcInteraction", getNpcInteraction);
    ...
    exports_36("getNpcCollisionAction", getNpcCollisionAction);
    ...
    exports_36("getItemUsageAction", getItemUsageAction);
    return {
        setters: [
...
System.register("world/sprites/fallingAshSprite", ["engine/data/Sprite"], function (exports_37, context_37) {
    "use strict";
...
ᣟ˙·.
RRRR`;
            exports_37("fallingAshSprite", fallingAshSprite = Sprite_2.Sprite.parse(fallingAshSpriteRaw));
        }
    };
});
System.register("world/objects/particles/WeatherParticle", ["engine/objects/Particle"], function (exports_38, context_38) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_38("WeatherParticle", WeatherParticle);
            WeatherParticle.DefaultDecaySpeed = 300;
        }
    };
});
System.register("world/objects/particles/FallingAsh", ["engine/math/Vector2", "world/sprites/fallingAshSprite", "world/objects/particles/WeatherParticle"], function (exports_39, context_39) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_39("FallingAsh", FallingAsh);
        }
    };
});
System.register("world/sprites/rainDropSprite", ["engine/data/Sprite"], function (exports_40, context_40) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_40("rainDropSpriteRaw", rainDropSpriteRaw = `width:1
height:1
name:
empty:'
...
ᣟ˙·.
RRRR`);
            exports_40("rainDropSprite", rainDropSprite = Sprite_3.Sprite.parse(rainDropSpriteRaw));
        }
    };
});
System.register("world/objects/particles/Raindrop", ["engine/math/Vector2", "world/sprites/rainDropSprite", "world/objects/particles/WeatherParticle"], function (exports_41, context_41) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_41("Raindrop", Raindrop);
        }
    };
});
System.register("world/sprites/snowFlakeSprite", ["engine/data/Sprite"], function (exports_42, context_42) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_42("snowFlakeSpriteRaw", snowFlakeSpriteRaw = `width:1
height:1
name:
empty:'
...
❆❅✶•·.
SSSSSS`);
            exports_42("snowFlakeSprite", snowFlakeSprite = Sprite_4.Sprite.parse(snowFlakeSpriteRaw));
        }
    };
});
System.register("world/objects/particles/Snowflake", ["engine/math/Vector2", "world/sprites/snowFlakeSprite", "world/objects/particles/WeatherParticle"], function (exports_43, context_43) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_43("Snowflake", Snowflake);
        }
    };
});
System.register("world/sprites/mistSprite", ["engine/data/Sprite"], function (exports_44, context_44) {
    "use strict";
...
''''''''''
YTRRRRRTTY`;
            exports_44("mistSprite", mistSprite = Sprite_5.Sprite.parse(mistSpriteRaw));
        }
    };
});
System.register("engine/weather/WeatherType", [], function (exports_45, context_45) {
    "use strict";
    var weatherTypes;
    ...
    return {
        setters: [],
        execute: function () {
            exports_45("weatherTypes", weatherTypes = ["normal", "rain", "ashfall", "snow", "rain_and_snow", "mist", "heavy_mist"]);
        }
    };
});
System.register("engine/weather/WeatherHelper", ["world/objects/particles/FallingAsh", "world/objects/particles/Raindrop", "world/objects/particles/Snowflake", "world/sprites/mistSprite", "engine/objects/Particle"], function (exports_46, context_46) {
    "use strict";
    ...
    exports_46("createWeatherParticle", createWeatherParticle);
    ...
    exports_46("getWeatherSkyTransparency", getWeatherSkyTransparency);
    return {
        setters: [
...
System.register("engine/objects/special/WeatherParticlesObject", ["engine/weather/WeatherHelper", "engine/math/Vector2", "engine/objects/Object2D"], function (exports_47, context_47) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_47("WeatherParticlesObject", WeatherParticlesObject);
        }
    };
});
System.register("engine/objects/special/ParticlesObject", ["engine/math/Vector2", "engine/objects/Object2D"], function (exports_48, context_48) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_48("ParticlesObject", ParticlesObject);
        }
    };
});
System.register("engine/objects/special/TilesObject", ["engine/objects/Object2D"], function (exports_49, context_49) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_49("TilesObject", TilesObject);
        }
    };
});
System.register("engine/objects/special/BlockedLayerObject", ["engine/math/Vector2", "engine/graphics/Cell", "engine/objects/Object2D", "engine/components/ObjectSkin", "engine/math/Grid"], function (exports_50, context_50) {
    "use strict";
    var Vector2_18, Cell_3, Object2D_7, ObjectSkin_5, Grid_4, _position, BlockedLayerObject;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_50("BlockedLayerObject", BlockedLayerObject);
        }
    };
});
System.register("engine/objects/special/SignalsLayerObject", ["engine/math/Vector2", "engine/graphics/Cell", "engine/objects/Object2D", "engine/components/ObjectSkin", "engine/signaling/SignalType", "engine/components/CompositeObjectSkin", "engine/math/Grid"], function (exports_51, context_51) {
    "use strict";
    var Vector2_19, Cell_4, Object2D_8, ObjectSkin_6, SignalType_1, SignalType_2, CompositeObjectSkin_2, Grid_5, SignalsLayerObject;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_51("SignalsLayerObject", SignalsLayerObject);
        }
    };
});
System.register("utils/color", ["engine/math/Color", "utils/math"], function (exports_52, context_52) {
    "use strict";
    var Color_2, math_3;
    ...
    exports_52("numberToHexColor", numberToHexColor);
    ...
    exports_52("mixColors", mixColors);
    return {
        setters: [
            function (Color_2_1) {
                Color_2 = Color_2_1;
...
System.register("engine/objects/special/NumberGridObject", ["engine/math/Vector2", "engine/graphics/Cell", "engine/objects/Object2D", "engine/components/ObjectSkin", "utils/color"], function (exports_53, context_53) {
    "use strict";
    var Vector2_20, Cell_5, Object2D_9, ObjectSkin_7, color_1, NumberGridObject, defaultDebugDrawOptions;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_53("NumberGridObject", NumberGridObject);
...
System.register("engine/lights/Light", ["engine/math/Color", "engine/objects/Object2D"], function (exports_54, context_54) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_54("Light", Light);
        }
    };
});
System.register("engine/lights/SkyLight", ["engine/lights/Light"], function (exports_55, context_55) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_55("SkyLight", SkyLight);
        }
    };
});
System.register("engine/lights/Lights", ["utils/color", "engine/math/Color", "engine/math/Vector2", "utils/math", "engine/math/Grid"], function (exports_56, context_56) {
    "use strict";
...
System.register("world/events/WeatherChangedGameEvent", ["engine/events/GameEvent"], function (exports_57, context_57) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            })(WeatherChangedGameEvent || (exports_57("WeatherChangedGameEvent", WeatherChangedGameEvent = {})));
        }
    };
});
System.register("engine/weather/Weather", ["engine/events/EventLoop", "engine/math/Vector2", "engine/weather/WeatherHelper", "engine/objects/Object2D", "utils/math", "engine/math/Grid", "world/events/WeatherChangedGameEvent"], function (exports_58, context_58) {
    "use strict";
    var EventLoop_1, Vector2_22, WeatherHelper_2, Object2D_11, math_5, Grid_7, WeatherChangedGameEvent_1, defaultLightIntensityAtNight, defaultLightIntensityAtDay, defaultTemperatureAtNight, defaultTemperatureAtDay, defaultMoisture, _position, Weather;
                ...
                meanPoint(array, newArray, position, decay = 2) {
                    ...
                    for (let i = Math.max(0, y - 1); i <= Math.min(array.height - 1, y + 1); i++) {
                        for (let j = Math.max(0, x - 1); j <= Math.min(array.width - 1, x + 1); j++) {
                            const pos = new Vector2_22.Vector2(j, i);
                            if ((i === y || j === x) &&
                                !(i === y && j === x) &&
...
System.register("engine/Level", ["engine/Scene", "engine/math/Vector2", "engine/events/EventLoop", "engine/events/GameEvent", "engine/signaling/SignalProcessor", "engine/math/Box2", "engine/ActionData", "engine/objects/Npc", "engine/objects/special/WeatherParticlesObject", "engine/objects/special/ParticlesObject", "engine/objects/special/TilesObject", "engine/objects/special/BlockedLayerObject", "engine/objects/special/SignalsLayerObject", "engine/objects/special/NumberGridObject", "engine/math/Color", "engine/lights/SkyLight", "engine/lights/Lights", "engine/weather/Weather", "engine/math/Grid"], function (exports_59, context_59) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_59("Level", Level);
        }
    };
});
System.register("engine/objects/Npc", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "engine/events/EventLoop", "engine/events/GameEvent", "engine/objects/Equipment", "engine/objects/NpcMovementOptions", "engine/math/Vector2"], function (exports_60, context_60) {
    "use strict";
...
System.register("engine/objects/Inventory", [], function (exports_61, context_61) {
    "use strict";
    var Inventory;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_61("Inventory", Inventory);
        }
    };
});
System.register("engine/graphics/Layers", [], function (exports_62, context_62) {
    "use strict";
    var Layers;
    ...
    return {
        setters: [],
        execute: function () {
            exports_62("Layers", Layers = ["objects", "particles", "ui"]);
        }
    };
});
System.register("engine/cameras/Camera", ["engine/math/Box2", "engine/math/Vector2", "engine/objects/Object2D"], function (exports_63, context_63) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_63("followOffset", followOffset = 4);
            ...
            exports_63("Camera", Camera);
        }
    };
});
System.register("engine/cameras/FollowCamera", ["engine/math/Vector2", "engine/cameras/Camera"], function (exports_64, context_64) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_64("FollowCamera", FollowCamera);
        }
    };
});
System.register("engine/graphics/CellInfo", [], function (exports_65, context_65) {
    "use strict";
...
System.register("engine/graphics/cellStyle", ["engine/math/Vector2"], function (exports_66, context_66) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_66("cellStyle", cellStyle = {
                borderColor: "#1114",
                borderWidth: 1,
                default: {
                    textColor: '#fff',
...
System.register("engine/graphics/CanvasContext", ["engine/math/Color", "engine/math/Grid", "engine/math/Rotation", "engine/math/Vector2", "engine/graphics/Cell", "engine/graphics/cellStyle"], function (exports_67, context_67) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_67("CanvasContext", CanvasContext);
        }
    };
});
System.register("engine/renderers/CanvasRenderer", ["utils/math", "engine/cameras/FollowCamera", "engine/math/Box2", "engine/math/Vector2", "engine/math/Rotation"], function (exports_68, context_68) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_68("CanvasRenderer", CanvasRenderer);
        }
    };
});
System.register("engine/objects/Object2D", ["engine/components/ObjectSkin", "engine/components/ObjectPhysics", "engine/objects/Inventory", "engine/math/Vector2"], function (exports_69, context_69) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_69("Object2D", Object2D);
        }
    };
});
System.register("engine/Scene", ["engine/objects/Object2D"], function (exports_70, context_70) {
    "use strict";
...
System.register("world/behaviors/WanderingBehavior", [], function (exports_71, context_71) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_71("WanderingBehavior", WanderingBehavior);
        }
    };
});
System.register("world/events/MountGameEvent", ["engine/events/GameEvent"], function (exports_72, context_72) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            })(MountGameEvent || (exports_72("MountGameEvent", MountGameEvent = {})));
        }
    };
});
System.register("world/events/RemoveObjectGameEvent", ["engine/events/GameEvent"], function (exports_73, context_73) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            })(RemoveObjectGameEvent || (exports_73("RemoveObjectGameEvent", RemoveObjectGameEvent = {})));
        }
    };
});
System.register("world/events/AddObjectGameEvent", ["engine/events/GameEvent"], function (exports_74, context_74) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            })(AddObjectGameEvent || (exports_74("AddObjectGameEvent", AddObjectGameEvent = {})));
        }
    };
});
System.register("world/behaviors/MountBehavior", ["world/behaviors/WanderingBehavior", "engine/events/EventLoop", "world/events/MountGameEvent", "world/events/RemoveObjectGameEvent", "world/events/AddObjectGameEvent", "engine/math/Vector2"], function (exports_75, context_75) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_75("MountBehavior", MountBehavior);
        }
    };
});
System.register("world/items", ["engine/objects/Item", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "world/behaviors/MountBehavior", "engine/events/EventLoop", "engine/events/GameEvent", "engine/objects/Npc", "engine/math/Vector2"], function (exports_76, context_76) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_76("SwordItem", SwordItem);
            exports_76("victoryItem", victoryItem = () => Item_1.Item.create("victory_item", new ObjectSkin_10.ObjectSkin().char(`W`)));
            exports_76("bambooSeed", bambooSeed = () => Item_1.Item.create("bamboo_seed", new ObjectSkin_10.ObjectSkin().char(`▄`).color('#99bc20')));
            exports_76("honeyPot", honeyPot = () => Item_1.Item.create("honey_pot", new ObjectSkin_10.ObjectSkin().char(`🍯`)));
            // TODO: reveals invisible underwater chests.
            exports_76("seaShell", seaShell = () => Item_1.Item.create("sea_shell", new ObjectSkin_10.ObjectSkin().char(`🐚`)));
            ...
            exports_76("GlassesItem", GlassesItem);
            ;
            ...
            exports_76("MudBootsItem", MudBootsItem);
            ;
            ...
            exports_76("SaddleItem", SaddleItem);
        }
    };
});
System.register("world/hero", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/items", "engine/objects/NpcMovementOptions", "engine/objects/Object2D", "engine/math/Vector2"], function (exports_77, context_77) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_77("hero", hero = new class extends Npc_3.Npc {
                constructor() {
...
System.register("ui/UIElement", ["engine/objects/Object2D"], function (exports_78, context_78) {
    "use strict";
...
System.register("ui/UIPanel", ["engine/graphics/Cell", "ui/UIElement", "engine/components/ObjectSkin", "engine/math/Grid"], function (exports_79, context_79) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_79("UIPanel", UIPanel);
        }
    };
});
System.register("ui/UISceneObject", ["ui/UIElement"], function (exports_80, context_80) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_80("UISceneObject", UISceneObject);
        }
    };
});
System.register("ui/HealthBarUi", ["engine/graphics/Cell", "ui/UIElement", "engine/components/ObjectSkin", "engine/math/Grid"], function (exports_81, context_81) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_81("HealthBarUi", HealthBarUi);
        }
    };
});
System.register("ui/UIObjectSkin", ["ui/UIElement"], function (exports_82, context_82) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_82("UIObjectSkin", UIObjectSkin);
        }
    };
});
System.register("ui/playerUi", ["engine/objects/Npc", "engine/ActionData", "ui/UIPanel", "ui/UIElement", "ui/UISceneObject", "ui/HealthBarUi", "engine/math/Vector2", "engine/components/ObjectSkin", "ui/UIObjectSkin", "engine/math/Grid"], function (exports_83, context_83) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_83("PlayerUi", PlayerUi);
        }
    };
});
System.register("engine/data/ObjectPhysicsBuilder", ["utils/math", "engine/math/Color", "engine/math/Vector2", "engine/components/ObjectPhysics"], function (exports_84, context_84) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_84("ObjectPhysicsBuilder", ObjectPhysicsBuilder);
        }
    };
});
System.register("world/objects/house", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/data/ObjectSkinBuilder", "engine/data/ObjectPhysicsBuilder", "engine/math/Vector2", "engine/components/ObjectPhysics"], function (exports_85, context_85) {
    "use strict";
 ...
 . . `).build(), Vector2_36.Vector2.from(options.position));
    ...
    return {
        ...
        execute: function () {
            ...
            exports_85("windowHorizontal", windowHorizontal = (options) => new Object2D_17.Object2D(Vector2_36.Vector2.zero, windowHorizontalSkin(), physicsUnitBlockedTransparent(options.transparency), Vector2_36.Vector2.from(options.position)));
            exports_85("wall", wall = (options) => new Object2D_17.Object2D(Vector2_36.Vector2.zero, wallSkin(), physicsUnitBlocked(), Vector2_36.Vector2.from(options.position)));
        }
    };
});
System.register("world/objects/fence", ["engine/components/ObjectSkin", "engine/objects/Object2D", "engine/components/ObjectPhysics", "engine/math/Vector2"], function (exports_86, context_86) {
    "use strict";
    var ObjectSkin_16, Object2D_18, ObjectPhysics_9, Vector2_37;
    var __moduleName = context_86 && context_86.id;
    function fence(options) {
        const object = new Object2D_18.Object2D(Vector2_37.Vector2.zero, new ObjectSkin_16.ObjectSkin().char(`☗`).color('Sienna'), new ObjectPhysics_9.ObjectPhysics().collision(), Vector2_37.Vector2.from(options.position));
        object.type = "fence";
        return object;
    }
    exports_86("fence", fence);
    return {
        setters: [
...
System.register("world/events/TeleportToEndpointGameEvent", ["engine/events/GameEvent"], function (exports_87, context_87) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            })(TeleportToEndpointGameEvent || (exports_87("TeleportToEndpointGameEvent", TeleportToEndpointGameEvent = {})));
        }
    };
});
System.register("world/objects/door", ["engine/components/ObjectSkin", "engine/objects/Object2D", "engine/components/ObjectPhysics", "engine/events/EventLoop", "world/events/TeleportToEndpointGameEvent", "engine/math/Vector2"], function (exports_88, context_88) {
    "use strict";
    var ObjectSkin_17, Object2D_19, ObjectPhysics_10, EventLoop_6, TeleportToEndpointGameEvent_1, Vector2_38, Door;
    var __moduleName = context_88 && context_88.id;
    function door(id, options = { position: [0, 0] }) {
        return new Door(id, options);
    }
    exports_88("door", door);
    return {
        setters: [
        ...
        execute: function () {
            Door = class Door extends Object2D_19.Object2D {
...
System.register("world/events/PlayerMessageGameEvent", ["engine/events/GameEvent"], function (exports_89, context_89) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            })(PlayerMessageGameEvent || (exports_89("PlayerMessageGameEvent", PlayerMessageGameEvent = {})));
        }
    };
});
System.register("world/events/TransferItemsGameEvent", ["engine/events/GameEvent"], function (exports_90, context_90) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            })(TransferItemsGameEvent || (exports_90("TransferItemsGameEvent", TransferItemsGameEvent = {})));
        }
    };
});
System.register("world/actions", ["engine/events/EventLoop", "world/events/PlayerMessageGameEvent", "world/events/TransferItemsGameEvent"], function (exports_91, context_91) {
    "use strict";
    ...
    exports_91("storageAction", storageAction);
    return {
        setters: [
...
System.register("world/objects/chest", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "world/actions", "engine/math/Vector2"], function (exports_92, context_92) {
    "use strict";
    var Object2D_20, ObjectSkin_18, ObjectPhysics_11, actions_1, Vector2_39, Chest;
    ...
    return {
        ...
        execute: function () {
            Chest = class Chest extends Object2D_20.Object2D {
                constructor() {
            ...
            exports_92("Chest", Chest);
        }
    };
});
System.register("engine/data/TileInfo", [], function (exports_93, context_93) {
    "use strict";
    var TileInfo;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_93("TileInfo", TileInfo);
        }
    };
});
System.register("engine/data/Tiles", ["engine/components/ObjectSkin", "engine/objects/Tile", "engine/data/TileInfo", "engine/math/Grid", "engine/math/Vector2"], function (exports_94, context_94) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_94("Tiles", Tiles);
            Tiles.defaultTile = new TileInfo_1.TileInfo('#331', '<default_tile>');
            Tiles.defaultSize = new Vector2_40.Vector2(20, 20);
        }
    };
});
System.register("world/levels/devHub", ["engine/Level", "world/objects/house", "world/objects/fence", "world/objects/door", "world/objects/chest", "world/items", "engine/data/Tiles", "engine/math/Vector2"], function (exports_95, context_95) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_95("devHubLevel", devHubLevel = level);
        }
    };
});
System.register("world/sprites/smokeSprite", ["engine/data/Sprite"], function (exports_96, context_96) {
    "use strict";
...
'''''''
RRTTYYY`;
            exports_96("smokeSprite", smokeSprite = Sprite_6.Sprite.parse(smokeSpriteRaw));
        }
    };
});
System.register("world/objects/particles/Smoke", ["engine/math/Vector2", "engine/objects/Particle", "world/sprites/smokeSprite"], function (exports_97, context_97) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_97("Smoke", Smoke);
            Smoke.ParticleType = "smoke";
        }
    };
});
System.register("world/objects/campfire", ["engine/components/ObjectPhysics", "engine/math/Vector2", "engine/data/Sprite", "engine/objects/Object2D", "world/objects/particles/Smoke"], function (exports_98, context_98) {
    "use strict";
    var ObjectPhysics_12, Vector2_43, Sprite_7, Object2D_21, Smoke_1, _position, Campfire;
    ...
    return {
        ...
        execute: function () {
            ...
            Campfire = class Campfire extends Object2D_21.Object2D {
                ...
                update(ticks) {
                    ...
                    if (isRainyWeather) {
                        ...
                        this.smokeTicks = Object2D_21.Object2D.updateValue(this.smokeTicks, ticks, 2000, () => {
            ...
            exports_98("Campfire", Campfire);
        }
    };
});
System.register("world/objects/mushroom", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "engine/math/Vector2", "engine/math/Color"], function (exports_99, context_99) {
    "use strict";
    var Object2D_22, ObjectSkin_20, ObjectPhysics_13, Vector2_44, Color_8, mushroom;
    ...
    return {
        ...
        execute: function () {
            exports_99("mushroom", mushroom = (options) => {
                ...
                const object = new Object2D_22.Object2D(Vector2_44.Vector2.zero, new ObjectSkin_20.ObjectSkin().char(`🍄`), physics, Vector2_44.Vector2.from(options.position));
                return object;
            });
        }
    };
});
System.register("world/levels/dungeon", ["engine/Level", "world/objects/door", "world/objects/campfire", "world/objects/house", "engine/data/Tiles", "world/objects/mushroom", "engine/math/Grid", "utils/math", "engine/math/Vector2"], function (exports_100, context_100) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_100("dungeonLevel", dungeonLevel = level);
        }
    };
});
System.register("world/npcs/bee", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/behaviors/WanderingBehavior", "engine/objects/NpcMovementOptions", "engine/math/Vector2"], function (exports_101, context_101) {
    "use strict";
    var Npc_5, ObjectSkin_21, WanderingBehavior_2, NpcMovementOptions_3, Vector2_46, Bee;
    var __moduleName = context_101 && context_101.id;
    function bee(options) {
        return new Bee(Vector2_46.Vector2.from(options.position));
    }
    exports_101("bee", bee);
    return {
        setters: [
...
System.register("world/behaviors/PreyGroupBehavior", ["world/behaviors/WanderingBehavior"], function (exports_102, context_102) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_102("PreyGroupBehavior", PreyGroupBehavior);
        }
    };
});
System.register("world/npcs/duck", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/behaviors/PreyGroupBehavior", "engine/math/Vector2"], function (exports_103, context_103) {
    "use strict";
    var Npc_6, ObjectSkin_22, PreyGroupBehavior_1, Vector2_47, Duck;
    var __moduleName = context_103 && context_103.id;
    function duck(options) {
        return new Duck(Vector2_47.Vector2.from(options.position));
    }
    exports_103("duck", duck);
    return {
        setters: [
            function (Npc_6_1) {
                Npc_6 = Npc_6_1;
...
System.register("world/npcs/sheep", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/behaviors/PreyGroupBehavior", "engine/math/Vector2"], function (exports_104, context_104) {
    "use strict";
    var Npc_7, ObjectSkin_23, PreyGroupBehavior_2, Vector2_48, Sheep;
    var __moduleName = context_104 && context_104.id;
    function sheep(options) {
        return new Sheep(Vector2_48.Vector2.from(options.position));
    }
    exports_104("sheep", sheep);
    return {
        setters: [
            function (Npc_7_1) {
                Npc_7 = Npc_7_1;
...
System.register("world/objects/lamp", ["engine/objects/Object2D", "engine/data/ObjectSkinBuilder", "engine/components/ObjectPhysics", "engine/math/Vector2"], function (exports_105, context_105) {
    "use strict";
    var Object2D_23, ObjectSkinBuilder_3, ObjectPhysics_14, Vector2_49, Lamp, lamp;
    ...
    return {
        ...
        execute: function () {
            Lamp = class Lamp extends Object2D_23.Object2D {
                constructor(options) {
                    const origin = new Vector2_49.Vector2(0, 2);
...
H`, {
                        ...
                        'H': ['#666', 'transparent'],
                    }).build(), physics, Vector2_49.Vector2.from(options.position));
                    this.setLampState(options.isOn === true);
                    this.setAction({
                        position: new Vector2_49.Vector2(0, 2),
                        action: (ctx) => ctx.obj.toggle(),
                        iconPosition: Vector2_49.Vector2.zero
                    });
                }
                setLampState(isOn) {
                    const o = this;
            ...
            exports_105("Lamp", Lamp);
            exports_105("lamp", lamp = (options) => {
...
System.register("world/objects/bamboo", ["engine/components/ObjectPhysics", "engine/data/ObjectSkinBuilder", "engine/math/Vector2", "engine/events/EventLoop", "engine/objects/Object2D", "world/events/RemoveObjectGameEvent", "world/events/TransferItemsGameEvent", "world/items"], function (exports_106, context_106) {
    "use strict";
    var ObjectPhysics_15, ObjectSkinBuilder_4, Vector2_50, EventLoop_8, Object2D_24, RemoveObjectGameEvent_2, TransferItemsGameEvent_2, items_3;
    var __moduleName = context_106 && context_106.id;
    function bamboo(options) {
        const origin = new Vector2_50.Vector2(0, 5);
...
D`, {
        ...
        }).build(), new ObjectPhysics_15.ObjectPhysics().collision(origin), Vector2_50.Vector2.from(options.position));
        object.type = "bamboo";
...
System.register("world/sprites/tree", ["engine/data/Sprite"], function (exports_107, context_107) {
    "use strict";
...
01S
'H'`;
            exports_107("treeSprite", treeSprite = Sprite_8.Sprite.parse(treeSpriteRaw));
            //console.log(treeSprite);
        }
    };
});
System.register("world/objects/Tree", ["engine/objects/Object2D", "world/events/WeatherChangedGameEvent"], function (exports_108, context_108) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_108("Tree", Tree);
            ;
        }
    };
});
System.register("world/objects/pineTree", ["engine/components/ObjectPhysics", "engine/math/Vector2", "world/sprites/tree", "world/objects/Tree"], function (exports_109, context_109) {
    "use strict";
    var ObjectPhysics_16, Vector2_51, tree_1, Tree_1, PineTree;
    var __moduleName = context_109 && context_109.id;
    function pineTree(options) {
        return new PineTree(Vector2_51.Vector2.from(options.position));
    }
    exports_109("pineTree", pineTree);
    return {
        setters: [
        ...
        execute: function () {
            PineTree = class PineTree extends Tree_1.Tree {
                constructor(position) {
                    const origin = new Vector2_51.Vector2(1, 3);
...
System.register("world/sprites/sakura", ["engine/data/Sprite"], function (exports_110, context_110) {
    "use strict";
...
'1S'
''H'`;
            exports_110("sakuraSprite", sakuraSprite = Sprite_9.Sprite.parse(sakuraSpriteRaw));
            //console.log(sakuraSprite);
        }
    };
});
System.register("world/objects/sakuraTree", ["engine/components/ObjectPhysics", "engine/math/Vector2", "world/sprites/sakura", "world/objects/Tree"], function (exports_111, context_111) {
    "use strict";
    var ObjectPhysics_17, Vector2_52, sakura_1, Tree_2, SakuraTree;
    var __moduleName = context_111 && context_111.id;
    function sakuraTree(options) {
        return new SakuraTree(Vector2_52.Vector2.from(options.position));
    }
    exports_111("sakuraTree", sakuraTree);
    return {
        setters: [
        ...
        execute: function () {
            SakuraTree = class SakuraTree extends Tree_2.Tree {
                constructor(position) {
                    const origin = new Vector2_52.Vector2(2, 3);
...
System.register("world/objects/beehive", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "world/items", "world/actions", "engine/math/Vector2"], function (exports_112, context_112) {
    "use strict";
    var Object2D_26, ObjectSkin_24, ObjectPhysics_18, items_4, actions_2, Vector2_53;
    var __moduleName = context_112 && context_112.id;
    function beehive(options) {
        const obj = new Object2D_26.Object2D(Vector2_53.Vector2.zero, new ObjectSkin_24.ObjectSkin().char(`☷`).color('black').background('orange'), new ObjectPhysics_18.ObjectPhysics().collision(), Vector2_53.Vector2.from(options.position));
        obj.inventory.addItems([items_4.honeyPot()]);
        obj.setAction(actions_2.storageAction(obj));
        return obj;
    }
    exports_112("beehive", beehive);
    return {
        setters: [
...
System.register("world/objects/natural", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "engine/math/Vector2"], function (exports_113, context_113) {
    "use strict";
    var Object2D_27, ObjectSkin_25, ObjectPhysics_19, Vector2_54, createUnitSkin, createUnitStaticObject, flower, wheat, hotspring;
    ...
    return {
        ...
        execute: function () {
            ...
            createUnitStaticObject = (options) => new Object2D_27.Object2D(Vector2_54.Vector2.zero, createUnitSkin(options.sym, options.color), new ObjectPhysics_19.ObjectPhysics(), Vector2_54.Vector2.from(options.position));
            exports_113("flower", flower = (options) => createUnitStaticObject({ ...options, sym: `❁`, color: 'red' }));
            exports_113("wheat", wheat = (options) => createUnitStaticObject({ ...options, sym: `♈`, color: 'yellow' }));
            exports_113("hotspring", hotspring = (options) => new Object2D_27.Object2D(Vector2_54.Vector2.zero, createUnitSkin(`♨`, 'lightblue'), new ObjectPhysics_19.ObjectPhysics().temperature('A'), Vector2_54.Vector2.from(options.position)));
        }
    };
});
System.register("world/levels/ggj2020demo/objects/pillar", ["engine/components/ObjectPhysics", "engine/data/ObjectSkinBuilder", "engine/math/Vector2", "engine/objects/Object2D"], function (exports_114, context_114) {
    "use strict";
    var ObjectPhysics_20, ObjectSkinBuilder_5, Vector2_55, Object2D_28, pillar;
    ...
    return {
        ...
        execute: function () {
            exports_114("pillar", pillar = (options) => {
                const origin = new Vector2_55.Vector2(0, 3);
...
B`, {
                ...
                return new Object2D_28.Object2D(origin, skin, physics, Vector2_55.Vector2.from(options.position));
            });
        }
    };
});
System.register("world/levels/ggj2020demo/objects/shop", ["engine/data/ObjectPhysicsBuilder", "engine/data/ObjectSkinBuilder", "engine/math/Vector2", "engine/objects/Object2D"], function (exports_115, context_115) {
    "use strict";
    var ObjectPhysicsBuilder_2, ObjectSkinBuilder_6, Vector2_56, Object2D_29, shop;
    ...
    return {
        ...
        execute: function () {
            exports_115("shop", shop = (options) => new Object2D_29.Object2D(new Vector2_56.Vector2(2, 3), new ObjectSkinBuilder_6.ObjectSkinBuilder(`▄▟▄▄▄▙▄
 █   █
 █████`, `LLLLLLL
 H   H
 BTTTB`, {
 ...
 ..... `).build(), Vector2_56.Vector2.from(options.position)));
        }
    };
});
System.register("world/levels/ggj2020demo/objects/arc", ["engine/data/ObjectPhysicsBuilder", "engine/data/ObjectSkinBuilder", "engine/math/Vector2", "engine/objects/Object2D"], function (exports_116, context_116) {
    "use strict";
    var ObjectPhysicsBuilder_3, ObjectSkinBuilder_7, Vector2_57, Object2D_30, arc;
    ...
    return {
        ...
        execute: function () {
            exports_116("arc", arc = (options) => new Object2D_30.Object2D(new Vector2_57.Vector2(2, 3), new ObjectSkinBuilder_7.ObjectSkinBuilder(`▟▄▄▄▙
█   █
█   █
█   █`, `LLLLL
H   H
...
.   .`).build(), Vector2_57.Vector2.from(options.position)));
        }
    };
});
System.register("world/tiles", ["engine/data/TileInfo"], function (exports_117, context_117) {
    "use strict";
...
System.register("world/levels/ggj2020demo/tiles", ["engine/data/Tiles", "world/tiles"], function (exports_118, context_118) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_118("levelTiles", levelTiles = Tiles_3.Tiles.parseTiles(`gggggggGGggggggggggggggggggGGgggg ggggggggGGgg ggG
...
System.register("world/levels/ggj2020demo/level", ["engine/Level", "world/npcs/bee", "world/npcs/duck", "world/npcs/sheep", "world/objects/lamp", "world/objects/house", "world/objects/bamboo", "world/objects/pineTree", "world/objects/sakuraTree", "world/objects/beehive", "world/objects/natural", "world/levels/ggj2020demo/objects/pillar", "world/levels/ggj2020demo/objects/shop", "world/levels/ggj2020demo/objects/arc", "world/levels/ggj2020demo/tiles", "world/objects/fence", "world/objects/door"], function (exports_119, context_119) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_119("level", level = new Level_3.Level('ggj2020demo', objects, tiles_2.levelTiles));
        }
    };
});
System.register("world/objects/signals/LightSource", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "engine/components/CompositeObjectSkin", "engine/math/Vector2", "engine/math/Rotation"], function (exports_120, context_120) {
    "use strict";
    var Object2D_31, ObjectSkin_26, ObjectPhysics_21, CompositeObjectSkin_3, Vector2_58, Rotation_5, LightSource;
    ...
    return {
        ...
        execute: function () {
            LightSource = class LightSource extends Object2D_31.Object2D {
                constructor(options) {
                    const physics = new ObjectPhysics_21.ObjectPhysics()
                        .light({ intensity: Number.parseInt(options.intensity || 'F'), color: options.color, position: new Vector2_58.Vector2() })
                        .signal({
                        position: new Vector2_58.Vector2(),
                    ...
                    super(Vector2_58.Vector2.zero, skin, physics, Vector2_58.Vector2.from(options.position));
                    this._isOn = false;
            ...
            exports_120("LightSource", LightSource);
        }
    };
});
System.register("world/levels/house", ["engine/Level", "world/objects/door", "world/objects/house", "engine/data/Tiles", "world/objects/signals/LightSource", "engine/math/Color", "engine/math/Vector2", "engine/math/Grid"], function (exports_121, context_121) {
    "use strict";
    var Level_4, door_4, house_4, Tiles_4, LightSource_1, Color_9, Vector2_59, Grid_15, walls, margin, left, top, width, height, campfires, lightSources, doors, objects, level, houseLevel;
    ...
    return {
        ...
        execute: function () {
            ...
            if (true) { // add gradient
                for (let y = 0; y < height; y++) {
                    for (let x = 0; x < width; x++) {
                        level.roofHolesLayer.setAt(new Vector2_59.Vector2(left + x, top + y), false);
                        level.roofLayer.setAt(new Vector2_59.Vector2(left + x, top + y), 15);
                    }
                }
            }
            exports_121("houseLevel", houseLevel = level);
        }
    };
});
System.register("world/levels/intro", ["world/objects/chest", "world/objects/lamp", "world/objects/house", "engine/events/EventLoop", "engine/events/GameEvent", "engine/Level", "world/objects/pineTree", "world/objects/door", "world/objects/bamboo", "engine/objects/Npc", "engine/components/ObjectSkin", "engine/data/Tiles", "world/items", "engine/math/Vector2"], function (exports_122, context_122) {
    "use strict";
    var chest_2, lamp_2, house_5, EventLoop_9, GameEvent_11, Level_5, pineTree_2, door_5, bamboo_2, Npc_8, ObjectSkin_27, Tiles_5, items_5, Vector2_60, lamps, doors, house1, tree1, chest1, trees, ulan, npcs, objects, introLevel;
    ...
    return {
        ...
        execute: function () {
            ...
            ulan = new Npc_8.Npc(new ObjectSkin_27.ObjectSkin().char('🐻'), new Vector2_60.Vector2(4, 4));
            ulan.setAction((ctx) => {
                const o = ctx.obj;
            ...
            exports_122("introLevel", introLevel = new Level_5.Level('intro', objects, Tiles_5.Tiles.createEmptyDefault()));
        }
    };
});
System.register("world/objects/headStone", ["engine/components/ObjectSkin", "engine/objects/Object2D", "engine/components/ObjectPhysics", "engine/math/Vector2"], function (exports_123, context_123) {
    "use strict";
    var ObjectSkin_28, Object2D_32, ObjectPhysics_22, Vector2_61, headStone;
    ...
    return {
        ...
        execute: function () {
            exports_123("headStone", headStone = (options) => new Object2D_32.Object2D(Vector2_61.Vector2.zero, new ObjectSkin_28.ObjectSkin().char(`🪦`).color('Sienna'), new ObjectPhysics_22.ObjectPhysics().collision(), Vector2_61.Vector2.from(options.position)));
        }
    };
});
System.register("world/levels/lights", ["world/objects/campfire", "engine/Level", "world/objects/pineTree", "world/objects/fence", "world/objects/headStone", "world/objects/house", "engine/data/Tiles", "world/objects/door", "engine/math/Vector2"], function (exports_124, context_124) {
    "use strict";
    var campfire_2, Level_6, pineTree_3, fence_3, headStone_1, house_6, Tiles_6, door_6, Vector2_62, fences, headStones, walls, tree2, campfires, doors, objects, level, lightsLevel;
    ...
    return {
        ...
        execute: function () {
            ...
            campfires = [
                new campfire_2.Campfire(new Vector2_62.Vector2(5, 4)),
                new campfire_2.Campfire(new Vector2_62.Vector2(9, 4)),
                new campfire_2.Campfire(new Vector2_62.Vector2(13, 4)),
                //
                new campfire_2.Campfire(new Vector2_62.Vector2(3, 17)),
            ];
            doors = [
            ...
            exports_124("lightsLevel", lightsLevel = level);
        }
    };
});
System.register("world/objects/particles/Mist", ["engine/components/ObjectSkin", "engine/data/Sprite", "engine/objects/Particle"], function (exports_125, context_125) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_125("Mist", Mist);
        }
    };
});
System.register("world/levels/mistlandLevel", ["engine/Level", "world/objects/fence", "world/objects/door", "engine/data/Tiles", "world/objects/campfire", "world/objects/particles/Mist", "world/objects/pineTree", "engine/math/Vector2"], function (exports_126, context_126) {
    "use strict";
    var Level_7, fence_4, door_7, Tiles_7, campfire_3, Mist_1, pineTree_4, Vector2_63, fences, width, height, trees, fires, doors, objects, mistlandLevel;
    ...
    return {
        ...
        execute: function () {
            ...
            fires = [
                new campfire_3.Campfire(new Vector2_63.Vector2(12, 12)),
            ];
            doors = [
                door_7.door('mistland', { position: [2, 2] }),
            ];
            objects = [...fences, ...doors, ...trees, ...fires];
            exports_126("mistlandLevel", mistlandLevel = new class extends Level_7.Level {
                constructor() {
                    super('mistland', objects, Tiles_7.Tiles.createEmpty(new Vector2_63.Vector2(width, height)));
                    this.weather.wind = new Vector2_63.Vector2(1, 0);
                }
                onLoaded() {
                    super.onLoaded();
                    this.fillMist(this);
...
System.register("world/levels/particlesLevel", ["engine/Level", "world/objects/fence", "world/objects/door", "engine/data/Tiles", "world/objects/campfire", "engine/math/Vector2"], function (exports_127, context_127) {
    "use strict";
    var Level_8, fence_5, door_8, Tiles_8, campfire_4, Vector2_64, fences, width, height, fires, doors, objects, particlesLevel;
    ...
    return {
        ...
        execute: function () {
            ...
            fires = [
                new campfire_4.Campfire(new Vector2_64.Vector2(10, 10)),
                new campfire_4.Campfire(new Vector2_64.Vector2(5, 20)),
            ];
            doors = [
                door_8.door('particles', { position: [2, 2] }),
            ];
            objects = [...fences, ...doors, ...fires];
            exports_127("particlesLevel", particlesLevel = new class extends Level_8.Level {
                constructor() {
                    super('particles', objects, Tiles_8.Tiles.createEmpty(new Vector2_64.Vector2(width, height)));
...
System.register("world/behaviors/HunterBehavior", ["world/behaviors/WanderingBehavior"], function (exports_128, context_128) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_128("HunterBehavior", HunterBehavior);
        }
    };
});
System.register("world/npcs/wolf", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/behaviors/HunterBehavior", "engine/objects/NpcMovementOptions", "engine/math/Vector2"], function (exports_129, context_129) {
    "use strict";
    var Npc_9, ObjectSkin_30, HunterBehavior_1, NpcMovementOptions_4, Vector2_65, Wolf;
    var __moduleName = context_129 && context_129.id;
    function wolf(options) {
        return new Wolf(Vector2_65.Vector2.from(options.position));
    }
    exports_129("wolf", wolf);
    return {
        setters: [
            function (Npc_9_1) {
                Npc_9 = Npc_9_1;
...
System.register("world/levels/sheep", ["world/objects/campfire", "world/npcs/sheep", "world/npcs/wolf", "engine/Level", "world/objects/pineTree", "world/objects/fence", "world/objects/door", "engine/data/Tiles", "engine/math/Vector2"], function (exports_130, context_130) {
    "use strict";
    var campfire_5, sheep_2, wolf_1, Level_9, pineTree_5, fence_6, door_9, Tiles_9, Vector2_66, sheeps, wolves, fences, tree2, campfires, doors, objects, sheepLevel;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_130("sheepLevel", sheepLevel = new Level_9.Level('sheep', objects, Tiles_9.Tiles.createEmptyDefault()));
        }
    };
});
System.register("world/objects/signals/Invertor", ["engine/objects/Object2D", "engine/components/ObjectPhysics", "engine/data/Sprite", "engine/math/Vector2", "engine/math/Rotation", "engine/components/CompositeObjectSkin"], function (exports_131, context_131) {
    "use strict";
    var Object2D_33, ObjectPhysics_23, Sprite_11, Vector2_67, Rotation_6, CompositeObjectSkin_4, Invertor;
    ...
    return {
        ...
        execute: function () {
            Invertor = class Invertor extends Object2D_33.Object2D {
                constructor(options) {
                    const physics = new ObjectPhysics_23.ObjectPhysics().signal({
                        position: Vector2_67.Vector2.zero,
                    ...
                    const indicatorSprite = Sprite_11.Sprite.parseSimple('▶▼◀▲');
                    const indicatorSkin = indicatorSprite.frames["0"][0];
                    const lockedFrame = Sprite_11.Sprite.parseSimple('◯').frames["0"][0].color('white');
                    super(Vector2_67.Vector2.zero, new CompositeObjectSkin_4.CompositeObjectSkin([indicatorSkin, skin]), physics, Vector2_67.Vector2.from((options === null || options === void 0 ? void 0 : options.position) || [0, 0]));
                    this._sprite = sprite;
            ...
            exports_131("Invertor", Invertor);
        }
    };
});
System.register("world/objects/signals/Pipe", ["engine/components/ObjectPhysics", "engine/math/Vector2", "engine/data/Sprite", "engine/objects/Object2D", "engine/components/CompositeObjectSkin", "engine/math/Rotation"], function (exports_132, context_132) {
    "use strict";
    var ObjectPhysics_24, Vector2_68, Sprite_12, Object2D_34, CompositeObjectSkin_5, Rotation_7, Pipe;
    ...
    return {
        ...
        execute: function () {
            Pipe = class Pipe extends Object2D_34.Object2D {
                constructor(options) {
                    const physics = new ObjectPhysics_24.ObjectPhysics().signal({
                        position: Vector2_68.Vector2.zero,
                    ...
                    super(Vector2_68.Vector2.zero, sprite.frames["0"][0], physics, Vector2_68.Vector2.from(options.position));
                    this._sprite = sprite;
                    this._indicatorSprite = indicatorSprite;
                    this.type = "pipe";
                    this.setAction(ctx => ctx.obj.rotate());
            ...
            exports_132("Pipe", Pipe);
        }
    };
});
System.register("engine/math/Orientation", [], function (exports_133, context_133) {
    "use strict";
    ...
    return {
        setters: [],
        execute: function () {
            exports_133("Orientations", Orientations = ["horizontal", "vertical"]);
            ...
            exports_133("OrientationHelper", OrientationHelper);
        }
    };
});
System.register("world/objects/signals/Lever", ["engine/components/ObjectPhysics", "engine/math/Vector2", "engine/data/Sprite", "engine/objects/Object2D", "engine/math/Rotation"], function (exports_134, context_134) {
    "use strict";
    var ObjectPhysics_25, Vector2_69, Sprite_13, Object2D_35, Rotation_8, Lever;
        ...
        execute: function () {
            Lever = class Lever extends Object2D_35.Object2D {
                constructor(options) {
                    ...
                    super(Vector2_69.Vector2.zero, sprite.frames["1"][0], physics, Vector2_69.Vector2.from(options.position));
                    this._isOn = false;
                    this._sprite = sprite;
                    this.type = "lever";
                    this.setAction(ctx => ctx.obj.toggle());
            ...
            exports_134("Lever", Lever);
        }
    };
});
System.register("world/objects/signals/PipeT", ["engine/components/ObjectPhysics", "engine/math/Vector2", "engine/data/Sprite", "engine/objects/Object2D", "engine/components/CompositeObjectSkin", "engine/math/Rotation"], function (exports_135, context_135) {
    "use strict";
    var ObjectPhysics_26, Vector2_70, Sprite_14, Object2D_36, CompositeObjectSkin_6, Rotation_9, PipeT;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_135("PipeT", PipeT);
        }
    };
});
System.register("world/objects/signals/PipeX", ["engine/components/ObjectPhysics", "engine/math/Vector2", "engine/data/Sprite", "engine/objects/Object2D", "engine/components/CompositeObjectSkin", "engine/math/Rotation"], function (exports_136, context_136) {
    "use strict";
    var ObjectPhysics_27, Vector2_71, Sprite_15, Object2D_37, CompositeObjectSkin_7, Rotation_10, PipeX;
        ...
        execute: function () {
            PipeX = class PipeX extends Object2D_37.Object2D {
                constructor(options) {
                    ...
                    super(Vector2_71.Vector2.zero, new CompositeObjectSkin_7.CompositeObjectSkin([pipeSkin, indicatorSkin]), physics, Vector2_71.Vector2.from(options.position));
                    this.type = "pipe_x";
    ...
    return {
        ...
        execute: function () {
            ...
            if (true) { // add signal pipes
                const padding = 2;
                const center = new Vector2_72.Vector2(9, 9);
                for (let x = padding + 1; x < width - padding - 1; x++) {
                    ...
                    const angleTop = new Vector2_72.Vector2(x, padding - 1).sub(center).angle;
                    fences.push(new LightSource_2.LightSource({ position: [x, padding - 1], color: color_3.hslToRgb(angleTop, 100, 50) }));
                    const angleBottom = new Vector2_72.Vector2(x, height - (padding - 1) - 1).sub(center).angle;
                ...
                for (let y = 1 + padding; y < height - padding - 1; y++) {
                    ...
                    const angleLeft = new Vector2_72.Vector2(padding - 1, y).sub(center).angle;
                    fences.push(new LightSource_2.LightSource({ position: [padding - 1, y], color: color_3.hslToRgb(angleLeft, 100, 50) }));
                    const angleRight = new Vector2_72.Vector2(width - (padding - 1) - 1, y).sub(center).angle;
            ...
            _position = new Vector2_72.Vector2();
            fences = fences.filter(x => !x.getWorldPosition(_position).equals(new Vector2_72.Vector2(9, 2)) && !x.getWorldPosition(_position).equals(new Vector2_72.Vector2(10, 2)));
            elements = [
            ...
            exports_137("signalLightsLevel", signalLightsLevel = new class extends Level_10.Level {
                constructor() {
                    super('signalLights', objects, Tiles_10.Tiles.createEmpty(new Vector2_72.Vector2(width, height)));
                    this.weather.wind = new Vector2_72.Vector2(1, 1);
                }
            }());
        }
    };
});
System.register("world/objects/signals/detectors/LightDetector", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "engine/math/Vector2", "engine/math/Rotation"], function (exports_138, context_138) {
    "use strict";
    var Object2D_38, ObjectSkin_31, ObjectPhysics_28, Vector2_73, Rotation_12, _position, LightDetector;
    ...
    return {
        ...
        execute: function () {
            _position = new Vector2_73.Vector2();
            LightDetector = class LightDetector extends Object2D_38.Object2D {
                constructor(options) {
                    ...
                    super(Vector2_73.Vector2.zero, skin, physics, Vector2_73.Vector2.from(options.position));
            ...
            exports_138("LightDetector", LightDetector);
        }
    };
});
System.register("world/objects/signals/detectors/WeatherDetector", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "engine/math/Vector2", "engine/math/Rotation"], function (exports_139, context_139) {
    "use strict";
    var Object2D_39, ObjectSkin_32, ObjectPhysics_29, Vector2_74, Rotation_13, _position, WeatherDetector;
        ...
        execute: function () {
            ...
            WeatherDetector = class WeatherDetector extends Object2D_39.Object2D {
                constructor(options) {
                    ...
                    super(Vector2_74.Vector2.zero, new ObjectSkin_32.ObjectSkin().char(`🗲`).color('black').background('gray'), physics, Vector2_74.Vector2.from(options.position));
            ...
            exports_139("WeatherDetector", WeatherDetector);
        }
    };
});
System.register("world/objects/signals/detectors/LifeDetector", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "engine/math/Vector2", "engine/math/Rotation"], function (exports_140, context_140) {
    "use strict";
    var Object2D_40, ObjectSkin_33, ObjectPhysics_30, Vector2_75, Rotation_14, _position, LifeDetector;
        ...
        execute: function () {
            ...
            LifeDetector = class LifeDetector extends Object2D_40.Object2D {
                constructor(options) {
                    ...
                    super(Vector2_75.Vector2.zero, new ObjectSkin_33.ObjectSkin().char(`🙑`).color('black').background('gray'), physics, Vector2_75.Vector2.from(options.position));
                    this.type = "life_detector";
                }
                processSignalTransfer(transfers) {
                    const npcsAt = [
                        this.scene.getNpcAt(this.getWorldPosition(_position)),
                        ...Vector2_75.Vector2.directions
            ...
            exports_140("LifeDetector", LifeDetector);
        }
    };
});
System.register("world/objects/signals/detectors/FireDetector", ["engine/objects/Object2D", "engine/components/ObjectSkin", "engine/components/ObjectPhysics", "engine/math/Vector2", "engine/math/Rotation"], function (exports_141, context_141) {
    "use strict";
    var Object2D_41, ObjectSkin_34, ObjectPhysics_31, Vector2_76, Rotation_15, _position, FireDetector;
        ...
        execute: function () {
            ...
            FireDetector = class FireDetector extends Object2D_41.Object2D {
                constructor(options) {
                    ...
                    super(Vector2_76.Vector2.zero, new ObjectSkin_34.ObjectSkin().char(`㊋`).color('black').background('gray'), physics, Vector2_76.Vector2.from(options.position));
            ...
            exports_141("FireDetector", FireDetector);
        }
    };
});
System.register("engine/objects/Group", ["engine/objects/Object2D"], function (exports_142, context_142) {
    "use strict";
...
System.register("world/levels/signalsLevel", ["engine/Level", "world/objects/fence", "world/objects/door", "engine/data/Tiles", "world/objects/signals/detectors/LightDetector", "world/objects/signals/Invertor", "world/objects/signals/Pipe", "world/objects/signals/Lever", "world/objects/signals/detectors/WeatherDetector", "world/objects/signals/detectors/LifeDetector", "world/objects/signals/detectors/FireDetector", "world/objects/signals/LightSource", "engine/math/Vector2", "engine/math/Color", "engine/objects/Group"], function (exports_143, context_143) {
    ...
    return {
        ...
        execute: function () {
            ...
            objects = [...fences, ...doors, ...elements];
            exports_143("signalsLevel", signalsLevel = new class extends Level_11.Level {
                constructor() {
                    super('signals', objects, Tiles_11.Tiles.createEmpty(new Vector2_77.Vector2(width, height)));
                    this.weather.wind = new Vector2_77.Vector2(1, 1);
                }
            }());
        }
    };
});
System.register("world/npcs/turtle", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/behaviors/MountBehavior", "engine/objects/NpcMovementOptions"], function (exports_144, context_144) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_144("Turtle", Turtle);
        }
    };
});
System.register("world/npcs/deer", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/behaviors/MountBehavior", "engine/math/Vector2"], function (exports_145, context_145) {
    "use strict";
    var Npc_11, ObjectSkin_36, MountBehavior_3, Vector2_78, Deer;
    var __moduleName = context_145 && context_145.id;
    function deer(options) {
        return new Deer(Vector2_78.Vector2.from(options.position));
    }
    exports_145("deer", deer);
    return {
        setters: [
            function (Npc_11_1) {
                Npc_11 = Npc_11_1;
...
System.register("world/npcs/snail", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/behaviors/MountBehavior"], function (exports_146, context_146) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_146("Snail", Snail);
        }
    };
});
System.register("world/npcs/Fish", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/behaviors/WanderingBehavior", "engine/objects/NpcMovementOptions"], function (exports_147, context_147) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_147("Fish", Fish);
        }
    };
});
System.register("world/npcs/Ghost", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/behaviors/WanderingBehavior"], function (exports_148, context_148) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_148("Ghost", Ghost);
        }
    };
});
System.register("world/npcs/Dragon", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/behaviors/MountBehavior", "engine/objects/NpcMovementOptions"], function (exports_149, context_149) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_149("Dragon", Dragon);
        }
    };
});
System.register("world/npcs/Monkey", ["engine/objects/Npc", "engine/components/ObjectSkin", "world/behaviors/WanderingBehavior", "world/items"], function (exports_150, context_150) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_150("Monkey", Monkey);
        }
    };
});
System.register("world/levels/terrain", ["engine/Level", "world/objects/door", "engine/data/Tiles", "world/npcs/turtle", "world/npcs/deer", "world/npcs/snail", "world/tiles", "world/npcs/Fish", "world/npcs/Ghost", "world/npcs/bee", "world/npcs/Dragon", "world/npcs/Monkey", "engine/math/Vector2"], function (exports_151, context_151) {
    "use strict";
    var Level_12, door_12, Tiles_12, turtle_1, deer_1, snail_1, tiles_3, Fish_1, Ghost_1, bee_2, Dragon_1, Monkey_1, Vector2_79, doors, mounts, npcs, objects, levelTiles, terrainLevel;
    ...
    return {
        ...
        execute: function () {
            ...
            mounts = [
                new turtle_1.Turtle(Vector2_79.Vector2.from([3, 5])),
                new turtle_1.Turtle(Vector2_79.Vector2.from([9, 7])),
                new deer_1.Deer(Vector2_79.Vector2.from([2, 5])),
                new deer_1.Deer(Vector2_79.Vector2.from([3, 18])),
                new snail_1.Snail(Vector2_79.Vector2.from([1, 1])),
                new Dragon_1.Dragon(Vector2_79.Vector2.from([2, 6])),
            ];
            npcs = [
                new Fish_1.Fish(Vector2_79.Vector2.from([15, 8])),
                new Fish_1.Fish(Vector2_79.Vector2.from([8, 4])),
                new bee_2.Bee(Vector2_79.Vector2.from([3, 15])),
                new Ghost_1.Ghost(Vector2_79.Vector2.from([8, 14])),
                new Monkey_1.Monkey(Vector2_79.Vector2.from([6, 15])),
            ];
         ...
         sswwwwwwwss             
          ssswwwwss              
           sswwwwsss             
            ...
            exports_151("terrainLevel", terrainLevel = new Level_12.Level('terrain', objects, levelTiles));
        }
    };
});
System.register("world/objects/particles/VolcanicGasMist", ["engine/components/ObjectSkin", "engine/data/Sprite", "engine/objects/Particle"], function (exports_152, context_152) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_152("VolcanicGasMist", VolcanicGasMist);
        }
    };
});
System.register("world/sprites/darkSmokeSprite", ["engine/data/Sprite"], function (exports_153, context_153) {
    "use strict";
...
''''''''''
RRRRTTTYYY`;
            exports_153("darkSmokeSprite", darkSmokeSprite = Sprite_17.Sprite.parse(darkSmokeSpriteRaw));
        }
    };
});
System.register("world/objects/particles/DarkSmoke", ["engine/math/Vector2", "engine/objects/Particle", "world/sprites/darkSmokeSprite"], function (exports_154, context_154) {
    "use strict";
    var Vector2_80, Particle_7, darkSmokeSprite_1, DarkSmoke;
    ...
    return {
        ...
        execute: function () {
            DarkSmoke = class DarkSmoke extends Particle_7.Particle {
                ...
                onNext() {
                    ...
                    function spread(particle) {
                        ...
                        const particlePos = particle.position;
                        const newState = particle.state + 1;
                        const newPositions = Vector2_80.Vector2.directions
                            .map(x => particlePos.clone().add(x));
                        for (const newPosition of newPositions) {
                            spreadTo(newPosition, newState);
                        }
            ...
            exports_154("DarkSmoke", DarkSmoke);
            DarkSmoke.ParticleType = "dark_smoke";
        }
    };
});
System.register("world/objects/volcanicMouth", ["engine/components/ObjectPhysics", "engine/components/ObjectSkin", "engine/math/Vector2", "engine/objects/Object2D", "world/objects/particles/DarkSmoke"], function (exports_155, context_155) {
    "use strict";
    var ObjectPhysics_32, ObjectSkin_43, Vector2_81, Object2D_43, DarkSmoke_1, VolcanicMouth;
    var __moduleName = context_155 && context_155.id;
    function volcanicMouth(options) {
        return new VolcanicMouth(Vector2_81.Vector2.from(options.position));
    }
    exports_155("volcanicMouth", volcanicMouth);
    return {
        setters: [
        ...
        execute: function () {
            VolcanicMouth = class VolcanicMouth extends Object2D_43.Object2D {
                constructor(position) {
                    super(Vector2_81.Vector2.zero, new ObjectSkin_43.ObjectSkin().background('darkred'), new ObjectPhysics_32.ObjectPhysics().light('8').temperature('F'), position);
                    this.smokeTicks = 0;
...
System.register("world/objects/volcano", ["engine/objects/Object2D", "engine/data/ObjectSkinBuilder", "engine/data/ObjectPhysicsBuilder", "engine/math/Vector2"], function (exports_156, context_156) {
    "use strict";
    var Object2D_44, ObjectSkinBuilder_8, ObjectPhysicsBuilder_4, Vector2_82;
    var __moduleName = context_156 && context_156.id;
    function volcano(options) {
        return new Object2D_44.Object2D(new Vector2_82.Vector2(0, 2), new ObjectSkinBuilder_8.ObjectSkinBuilder(`        
...
oooooooo`, {
 ...
 ...... 
........`).build(), Vector2_82.Vector2.from(options.position));
    }
    exports_156("volcano", volcano);
    return {
        setters: [
...
System.register("world/levels/volcanicLevel", ["engine/Level", "world/objects/fence", "world/objects/door", "engine/data/Tiles", "world/objects/particles/VolcanicGasMist", "world/objects/volcanicMouth", "world/objects/volcano", "engine/math/Vector2"], function (exports_157, context_157) {
    "use strict";
    var Level_13, fence_8, door_13, Tiles_13, VolcanicGasMist_1, volcanicMouth_1, volcano_1, Vector2_83, fences, width, height, trees, volcanoes, fires, doors, objects, volcanicLevel;
    ...
    return {
        ...
        execute: function () {
            ...
            fires = [
                new volcanicMouth_1.VolcanicMouth(Vector2_83.Vector2.from([12, 12])),
                new volcanicMouth_1.VolcanicMouth(Vector2_83.Vector2.from([12, 13])),
                new volcanicMouth_1.VolcanicMouth(Vector2_83.Vector2.from([13, 12])),
                new volcanicMouth_1.VolcanicMouth(Vector2_83.Vector2.from([13, 13])),
                //
                new volcanicMouth_1.VolcanicMouth(Vector2_83.Vector2.from([10, 5])),
                new volcanicMouth_1.VolcanicMouth(Vector2_83.Vector2.from([3, 16])),
            ];
            doors = [
                door_13.door('volcanic', { position: [2, 2] }),
            ];
            objects = [...fences, ...doors, ...trees, ...volcanoes, ...fires];
            exports_157("volcanicLevel", volcanicLevel = new class extends Level_13.Level {
                constructor() {
                    super('volcanic', objects, Tiles_13.Tiles.createEmpty(new Vector2_83.Vector2(width, height)));
                    this.weather.wind = new Vector2_83.Vector2(1, 0);
                }
                onLoaded() {
                    super.onLoaded();
                ...
                fillGasMist(scene) {
                    ...
                    for (let y = box.min.y; y < box.max.y; y++) {
                        for (let x = box.min.x; x < box.max.x; x++) {
                            const p = new Vector2_83.Vector2(x, y);
                            if (scene.particlesObject.isParticlePositionBlocked(p)) {
                                continue;
                            }
...
System.register("world/levels/levels", ["world/levels/devHub", "world/levels/dungeon", "world/levels/ggj2020demo/level", "world/levels/house", "world/levels/intro", "world/levels/lights", "world/levels/mistlandLevel", "world/levels/particlesLevel", "world/levels/sheep", "world/levels/signalLightsLevel", "world/levels/signalsLevel", "world/levels/terrain", "world/levels/volcanicLevel"], function (exports_158, context_158) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_158("rawLevels", rawLevels = dict);
            exports_158("levels", levels = {});
...
System.register("utils/misc", ["engine/data/ObjectSkinBuilder", "engine/objects/Object2D", "engine/components/ObjectPhysics", "engine/math/Vector2"], function (exports_159, context_159) {
    "use strict";
    var ObjectSkinBuilder_9, Object2D_45, ObjectPhysics_33, Vector2_84;
    ...
    exports_159("createTextObjectSkin", createTextObjectSkin);
    function createTextObject(text, pos) {
        const skin = createTextObjectSkin(text);
        const t = new Object2D_45.Object2D(Vector2_84.Vector2.zero, skin, new ObjectPhysics_33.ObjectPhysics(), pos);
        t.type = "victory_text_object";
        return t;
    }
    exports_159("createTextObject", createTextObject);
...
System.register("world/events/LoadLevelGameEvent", ["engine/events/GameEvent"], function (exports_160, context_160) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            })(LoadLevelGameEvent || (exports_160("LoadLevelGameEvent", LoadLevelGameEvent = {})));
        }
    };
});
System.register("world/events/TeleportToPositionGameEvent", ["engine/events/GameEvent"], function (exports_161, context_161) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            })(TeleportToPositionGameEvent || (exports_161("TeleportToPositionGameEvent", TeleportToPositionGameEvent = {})));
        }
    };
});
System.register("ui/UIText", ["utils/misc", "ui/UIElement"], function (exports_162, context_162) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_162("UIText", UIText);
        }
    };
});
System.register("ui/UIItem", ["engine/math/Vector2", "engine/graphics/Cell", "ui/UIElement", "ui/UISceneObject", "ui/UIText", "engine/components/ObjectSkin", "engine/math/Grid"], function (exports_163, context_163) {
    "use strict";
    var Vector2_85, Cell_9, UIElement_7, UISceneObject_2, UIText_1, ObjectSkin_44, Grid_16, UIItem;
        ...
        execute: function () {
            UIItem = class UIItem extends UIElement_7.UIElement {
                constructor(parent, item, position) {
                    ...
                    this.uiText.position = new Vector2_85.Vector2(1, 0);
                }
                update(ticks) {
                    super.update(ticks);
                ...
                createBackground() {
                    ...
                    const skin = new ObjectSkin_44.ObjectSkin(Grid_16.Grid.from([cells]));
                    return skin;
                }
            };
            exports_163("UIItem", UIItem);
        }
    };
});
System.register("ui/UIEquipment", ["engine/math/Vector2", "engine/graphics/Cell", "ui/UIElement", "engine/components/ObjectSkin", "engine/math/Grid"], function (exports_164, context_164) {
    "use strict";
    var Vector2_86, Cell_10, UIElement_8, ObjectSkin_45, Grid_17, UIEquipment;
        ...
        execute: function () {
            UIEquipment = class UIEquipment extends UIElement_8.UIElement {
                ...
                createEquipmentSkin() {
                    ...
                    const cells = new Grid_17.Grid(new Vector2_86.Vector2(1, this.uiItems.length))
                        .fill(v => {
            ...
            exports_164("UIEquipment", UIEquipment);
        }
    };
});
System.register("ui/UIDialog", ["controls", "engine/math/Vector2", "ui/UIElement", "ui/UIPanel"], function (exports_165, context_165) {
    "use strict";
    var controls_1, Vector2_87, UIElement_9, UIPanel_2, UIDialog;
        ...
        execute: function () {
            UIDialog = class UIDialog extends UIElement_9.UIElement {
                constructor(size, parent = null) {
                    super(parent);
                    this.close();
                    this.uiPanel = new UIPanel_2.UIPanel(this, new Vector2_87.Vector2(), size);
                }
                handleControls() {
            ...
            exports_165("UIDialog", UIDialog);
        }
    };
});
System.register("ui/UIInventory", ["controls", "engine/math/Vector2", "engine/objects/Npc", "ui/UIItem", "ui/UIEquipment", "ui/UIDialog"], function (exports_166, context_166) {
    "use strict";
    var controls_2, Vector2_88, Npc_17, UIItem_1, UIEquipment_1, UIDialog_1, UIInventory;
        ...
        execute: function () {
            UIInventory = class UIInventory extends UIDialog_1.UIDialog {
                ...
                constructor(object, cameraSize) {
                    ...
                    const position = new Vector2_88.Vector2(0, cameraSize.height - dialogHeight);
                    const size = new Vector2_88.Vector2(dialogWidth, dialogHeight);
                    super(size, null);
                    this.object = object;
                ...
                refresh() {
                    ...
                    for (const item of this.object.inventory.items) {
                        const uiItem = new UIItem_1.UIItem(this.uiPanel, item, new Vector2_88.Vector2(2, 1 + index));
                    ...
                    this.uiEquipment.position = new Vector2_88.Vector2(1, 1);
                }
            };
            exports_166("UIInventory", UIInventory);
        }
    };
});
System.register("world/levels/effectsLevel", ["engine/Level", "world/objects/door", "engine/data/Tiles", "world/objects/campfire", "engine/math/Vector2", "world/tiles"], function (exports_167, context_167) {
    "use strict";
    var Level_14, door_14, Tiles_14, campfire_6, Vector2_89, tiles_4, fences, fires, doors, objects, levelTiles, effectsLevel;
    ...
    return {
        ...
        execute: function () {
            fences = [];
            fires = [
                new campfire_6.Campfire(new Vector2_89.Vector2(10, 10)),
                new campfire_6.Campfire(new Vector2_89.Vector2(5, 20)),
            ];
            doors = [
                door_14.door('effects_level', { position: [2, 2] }),
            ];
            objects = [...fences, ...doors, ...fires];
            levelTiles = Tiles_14.Tiles.parseTiles(`                                 
        MMMMM                        
        MMM    wwwwwwww              
         M    wwwwwwwwwww            
          wwwwwwWWWWWWWwwwwwww       
       ...
       ssswwwwwwWWWWWWWwwwwwww       
        ssssswWWWWWWWWWWWwwwwwww     
           sssswwwwwwwwwsss          
            ...
            exports_167("effectsLevel", effectsLevel = new class extends Level_14.Level {
                constructor() {
                    super('effects', objects, levelTiles);
                    this.weather.wind = new Vector2_89.Vector2(1, 1);
                }
                onLoaded() {
                    super.onLoaded();
...
System.register("main", ["engine/events/GameEvent", "engine/events/EventLoop", "engine/Scene", "engine/ActionData", "engine/graphics/cellStyle", "engine/graphics/CanvasContext", "world/hero", "ui/playerUi", "engine/weather/WeatherType", "world/levels/levels", "world/events/TeleportToEndpointGameEvent", "controls", "world/events/MountGameEvent", "world/events/PlayerMessageGameEvent", "world/events/AddObjectGameEvent", "world/events/TransferItemsGameEvent", "utils/misc", "world/events/LoadLevelGameEvent", "world/events/RemoveObjectGameEvent", "world/events/TeleportToPositionGameEvent", "ui/UIInventory", "ui/UIDialog", "engine/math/Vector2", "engine/renderers/CanvasRenderer", "engine/cameras/Camera", "engine/cameras/FollowCamera", "world/levels/effectsLevel"], function (exports_168, context_168) {
    ...
    function teleportToEndpoint(portalId, teleport, object) {
        ...
        if ((portalPositions === null || portalPositions === void 0 ? void 0 : portalPositions.length) === 2) {
            ...
            const teleportPosition = teleport.getWorldPosition(new Vector2_90.Vector2());
            ...
            teleportTo(scene.name, pairPortalPosition.clone().add(new Vector2_90.Vector2(0, 1)));
        }
        else {
            ...
            if ((pairPortals === null || pairPortals === void 0 ? void 0 : pairPortals.length) !== 0) {
                ...
                const position = pairPortal.position.clone().add(new Vector2_90.Vector2(0, 1));
    ...
    function interact() {
        ...
        if (item) {
            ...
            const subject = scene.getNpcAt(item.getWorldPosition(new Vector2_90.Vector2()));
            if (itemActionData) {
    ...
    function createDialog(camera) {
        ...
        const uiPanel = new UIDialog_2.UIDialog(new Vector2_90.Vector2(dialogWidth, dialogHeight))
    ...
    return {
        ...
        execute: function () {
                ...
                handleEvent(ev) {
                    if (ev.type === "user_action" && ev.args.subtype === "npc_talk") {
                        ...
                        if (args.items.find(x => x.type === "victory_item")) {
                            EventLoop_10.emitEvent(AddObjectGameEvent_2.AddObjectGameEvent.create(misc_2.createTextObject(`VICTORY!`, new Vector2_90.Vector2(6, 6))));
                        }
                    }
            ...
            game = new Game();
            scene = effectsLevel_1.effectsLevel;
            debug = true;
            if (debug) {
                selectLevel(null, effectsLevel_1.effectsLevel);
...
System.register("world/objects/particles/WaterRipple", ["engine/objects/Particle", "world/sprites/waterRippleSprite"], function (exports_169, context_169) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_169("WaterRipple", WaterRipple);
        }
    };
});
